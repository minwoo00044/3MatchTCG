...
// BattleManager의 기존 경로를 그대로 탑니다. 적을 별도 매니저로 빼면 Battlefield 소유권이
// 갈리고 스킬 실행 경로가 둘이 되는데, 스킬은 멱등이 아니라 그중 하나가 이중 적용이 됩니다.
// 플레이어와 다른 것은 발동 계기(이벤트 / 시간)와 수치 공식뿐입니다. (AGENTS.md §5)
//
// MonoBehaviour가 아닙니다. Model 층이며 Unity API를 쓰지 않습니다. (AGENTS.md §1)
